...
public class ReceiveProblematicParcelPageTests extends SapBaseClass {
    ...
    @Test(groups = {CoreConstants.GROUP_SLACK_BUG},priority = 302)
    ...
    @Test(groups = {CoreConstants.GROUP_SLACK_BUG},priority = 303)
    public void verifyPartialDeliveryFunctionality()
    {
