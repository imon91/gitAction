...
public class MyBagPageObjects extends WebAppBaseClass {

    private AndroidDriver<WebElement> androidDriver;
    private MyActions myActions;
    private Random random;
    private PLPPageObjects productListingPageObjects;
    ...
    public MyBagPageObjects(AndroidDriver<WebElement> androidDriver) throws Exception {
        this.androidDriver = androidDriver;
        PageFactory.initElements(new AppiumFieldDecorator(androidDriver), this);
        myActions = new MyActions();
        random = new Random();
        productListingPageObjects = new PLPPageObjects(androidDriver);
    ...
    public String getCartItemCount(){
       return myActions.action_getText(cartItemsCount);
    }

    public String getCartValueTotal(){
        return myActions.action_getText(cartTotalValue);
    }
